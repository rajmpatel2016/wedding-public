    ...
    <Container link="/tabs/home/payment">
      ...
      >
        ...
        >
          ...
          <Text style={{ color: "black", fontWeight: "600" }}>$100</Text>
        </Text>
        <CustomButton title="Pay now" />
        <Pressable style={styles.blackButton} onPress={FinishPayment}>
          <Text
            style={{
              fontWeight: "600",
              color: "white",
...
const styles = StyleSheet.create({
  ...
  titleBlackButton: { fontSize: 16, color: "white", textAlign: "center" },
});
